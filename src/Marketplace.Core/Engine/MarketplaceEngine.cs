...
{
    public class MarketplaceEngine : IEngine
    {
        ...
        private static void CallConfigureServicesMethodOfStartups(IServiceCollection services,
        ...
        private static void CallConfigureMethodOfStartups(IApplicationBuilder application,
            IWebHostEnvironment environment, ITypeFinder typeFinder)
        {
            var startups = typeFinder.FindClassesOfType<IAppStartup>();
        ...
        public void ConfigureRequestPipeline(IApplicationBuilder application, IWebHostEnvironment environment)
        {
            ...
            CallConfigureMethodOfStartups(application, environment, typeFinder);
